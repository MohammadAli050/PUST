<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptFinalMark.aspx.cs" Inherits="EMS.Module.result.Report.RptFinalMark" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Head" runat="Server">
    ...
    <style type="text/css">
        ...
        #ctl00_MainContainer_ucDepartment_ddlDepartment, #ctl00_MainContainer_ucProgram_ddlProgram, #ctl00_MainContainer_ddlExaminer,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div class="row">
        <div class="col-sm-4" style="font-size: 12pt; margin-top: 10pt;">
            <label><b style="color: black; font-size: 26px">Consolidated Marks Sheet</b></label>
        </div>
            ...
            <div class="card" runat="server" id="divDD">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <b>Choose Examiner</b>
                            <asp:DropDownList ID="ddlExaminer" AutoPostBack="true" CssClass="form-control" Width="100%" OnSelectedIndexChanged="ddlExaminer_SelectedIndexChanged" runat="server">

                                <%--<asp:ListItem Selected="True" Value="0">Select</asp:ListItem>--%>
                                <%-- <asp:ListItem Value="1">Internal Examiner</asp:ListItem>
                                <asp:ListItem Value="2">Tabulator One (External Examiner)</asp:ListItem>
                                <asp:ListItem Value="3">Tabulator Two (External Examiner)</asp:ListItem>
                                <asp:ListItem Value="4">Tabulator Three (External Examiner)</asp:ListItem>
                                <asp:ListItem Value="5">Third Examiner (Inside University)</asp:ListItem>
                                <asp:ListItem Value="6">Tabulator One (Third Examiner)</asp:ListItem>
                                <asp:ListItem Value="7">Tabulator Two (Third Examiner)</asp:ListItem>
                                <asp:ListItem Value="8">Tabulator Three (Third Examiner)</asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <br />
