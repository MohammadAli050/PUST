...
{
    public partial class RptGradeSheetProvisional : BasePage
    {
        ...
        [WebMethod]
        public static string Loadgradesheetprovisonal(string heldInID, string roll)
        {
            try {
                ...
                parameters2.Add(new SqlParameter { ParameterName = "@Roll", SqlDbType = System.Data.SqlDbType.VarChar, Value = roll });
                parameters3.Add(new SqlParameter { ParameterName = "@Roll", SqlDbType = System.Data.SqlDbType.VarChar, Value = roll });

                DataTable dt = DataTableManager.GetDataFromQuery("GetSemesterResultReportByHeldIn", parameters1);
                DataTable dt2 = DataTableManager.GetDataFromQuery("GetStudentInfoForTabulation", parameters2);
                DataTable dt3 = DataTableManager.GetDataFromQuery("GetAcademicGradeSheetByRoll", parameters3);
                var listData = DataTableMethods.ConvertDataTable<SemesterResultList>(dt);

                var list = listData.Where(x => x.Roll == roll);
