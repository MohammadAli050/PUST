<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptTabulationSheetV2.aspx.cs" Inherits="EMS.Module.result.Report.RptTabulationSheetV2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12" style="font-size: 12pt; margin-top: 10pt;">
            <label><b style="color: black; font-size: 26px">Tabulation Sheet</b></label>
        </div>
    </div>
