<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" 
    CodeBehind="SingleStudentRegistration.aspx.cs" Inherits="EMS.Module.registration.SingleStudentRegistration" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="pnlRegisterOffice" runat="server">
                                <div style="float: Right; margin-right: 15px;">
                                    <asp:Button ID="btnApproveRegisterOffice" runat="server" Visible="false" Enabled="true" CssClass="btnNew success" Height="30px" Width="200px" Text="Confirm Registration" OnClick="btnApproveRegisterOffice_Click" OnClientClick=" return confirm('Are you sure you want to Confirm Student Registration?');" />
                                </div>
                            </asp:Panel>
                                        ...
                                        <asp:GridView runat="server" ID="gvCourseRegistration" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Section" HeaderStyle-Width="20%">
                                                    <ItemTemplate>
                                                        <div style="text-align: center;">
                                                            <asp:Button ID="btnSectionAdd" runat="server" OnClick="btnSectionAdd_Click" Text="Add" Width="50" ForeColor="Blue"
                                                                ToolTip="Add section." CommandArgument='<%#Eval("ID") %>'></asp:Button>

                                                            <asp:Button ID="btnRemoveSection" runat="server" Visible="false" OnClick="btnRemoveSection_Click" Text="Remove" Width="65" ForeColor="Crimson"
                                                ...
                                                <asp:TemplateField HeaderText="Status" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblStatus" Text='<%#Eval("RetakeNo").ToString()=="1" ? "Submitted to Advisor" : Eval("RetakeNo").ToString()=="2" ? "Submitted to HOD" :Eval("RetakeNo").ToString()=="3" ?"Submitted to Adm. Office":Eval("RetakeNo").ToString()=="4" ?"Submitted to Reg. Office":Eval("RetakeNo").ToString()=="5" ?"Registration Done": "Request for Registration" %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div style="text-align: center;">
                                                            <asp:DropDownList ID="ddlCourseStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCourseStatus_SelectedIndexChanged">
                                                                ...
                                                                <asp:ListItem Text="SS" Value="11"></asp:ListItem>
                        ...
                        <div style="clear: both;">
                            <div>
                                <asp:GridView ID="GridViewSection" runat="server" DataKeyNames="AcaCalSectionID"
                                    ...
                                    OnSelectedIndexChanged="GridViewSection_SelectedIndexChanged" Width="700">
                                    <Columns>
