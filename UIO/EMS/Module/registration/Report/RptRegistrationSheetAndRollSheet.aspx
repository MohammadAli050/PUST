<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptRegistrationSheetAndRollSheet.aspx.cs" Inherits="EMS.Module.registration.Report.RptRegistrationSheetAndRollSheet" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12" style="font-size: 12pt; margin-top: 10pt;">
            <label><b style="color: black; font-size: 26px">Registration Sheet</b></label>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <br />
                            <asp:Button ID="btnRegistrationSheet" runat="server" CssClass="btn-info w-100" Text="Registration Sheet" OnClick="btnRegistrationSheet_Click" OnClientClick="this.value = 'Loading Data....'; this.disabled = true;" UseSubmitBehavior="false" />
        ...
        <Animations>
            <OnUpdating>
                <Parallel duration="0">
                    ...
                    <EnableAction AnimationTarget="btnRegistrationSheet" Enabled="false" />                   
                </Parallel>
            </OnUpdating>
            <OnUpdated>
                <Parallel duration="0">
                    <ScriptAction Script="onComplete();" />
                    <EnableAction AnimationTarget="btnRegistrationSheet" Enabled="true" />
                </Parallel>
            </OnUpdated>
        </Animations>
    </ajaxToolkit:UpdatePanelAnimationExtender>
