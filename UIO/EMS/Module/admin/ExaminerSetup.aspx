<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="ExaminerSetup.aspx.cs" Inherits="EMS.Module.admin.ExaminerSetup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div class="container-fluid">
        <asp:UpdatePanel ID="UpdatePanel4" class="row" runat="server">
            <ContentTemplate>
                <div class="col-md-12">
                    <div class="h2 text-primary pt-2 border-bottom">Examiner Setup</div>
                </div>
                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="gvStudentList" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="table table-bordered" EmptyDataText="No data found." Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblExammID" Font-Bold="true" Text='<%#Eval("ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Course">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblTitle" Font-Bold="true" Text='<%#Eval("Title") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Second Examiner">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblSecondExaminor" Font-Bold="true" Text='<%#Eval("SecondExaminor") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle Width="15%" />
                                                <%-- <ItemStyle HorizontalAlign="Center" />--%>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Third Examiner">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblThirdExaminor" Font-Bold="true" Text='<%#Eval("ThirdExaminor") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle Width="15%" />
                                                <%--<ItemStyle HorizontalAlign="Center" />--%>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Exam Name">
                                                <%--  <HeaderTemplate>
                                                        <asp:Button ID="btnExam" runat="server" Text="Assign Exam" OnClick="btnExam_Click" />
                                                    </HeaderTemplate>--%>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Assign Examiner">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Button ID="btnExaminer" runat="server" Text="Assign Examiner" CommandArgument='<%#Eval("ID")  %>' OnClick="btnExaminer_Click" />
                                                </ItemTemplate>
                                                                            ...
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <td>
                                                                                            <uc1:DepartmentUserControl runat="server" Enabled="false" ID="DepartmentUserControl1" OnDepartmentSelectedIndexChanged="DepartmentUserControl1_DepartmentSelectedIndexChanged" />
                                                                                        </td>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="auto-style9">
                                                                                        ...
                                                                                        <asp:DropDownList ID="ddlEx1" runat="server" Enabled="false" class="dropdown"></asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
