<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentGradeProcess.aspx.cs" Inherits="EMS.Module.AdmitCard.RptStudentGradeProcess" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <br />
                            <asp:Button ID="btnLoad" runat="server" CssClass="btn-info w-100" Text="Load Admit Card" OnClick="btnLoad_Click" OnClientClick="this.value = 'Please wait....'; this.disabled = true;" UseSubmitBehavior="false" Style="display:none;" />
                            <asp:Button ID="btnProcess" runat="server" CssClass="btn-info w-100" Text="Process Grade" OnClick="btnProcess_Click" OnClientClick="this.value='Please wait....'; this.disabled = true;" UseSubmitBehavior="false"/>
                        </div>
                    </div>
